 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://Service/", wsdlLocation = "http://localhost:8081/?wsdl")
    ...
    extends Service
{
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://Service/", "Banque_ServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Service/", "Banque_ServicePort"), BanqueService.class, features);
    }
