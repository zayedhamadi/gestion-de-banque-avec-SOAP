...
public class ObjectFactory {
    ...
    private final static QName _TransfertResponse_QNAME = new QName("http://Service/", "transfertResponse");
    private final static QName _ExistResponse_QNAME = new QName("http://Service/", "existResponse");
    private final static QName _SaveCompte_QNAME = new QName("http://Service/", "saveCompte");
    private final static QName _GetComptesResponse_QNAME = new QName("http://Service/", "getComptesResponse");
    private final static QName _GetActeResponse_QNAME = new QName("http://Service/", "getActeResponse");
    ...
    private final static QName _GetHistResponse_QNAME = new QName("http://Service/", "getHistResponse");
    private final static QName _Retirer_QNAME = new QName("http://Service/", "retirer");
    private final static QName _SaveCompteResponse_QNAME = new QName("http://Service/", "saveCompteResponse");
    private final static QName _GetHist_QNAME = new QName("http://Service/", "getHist");
    private final static QName _Verser_QNAME = new QName("http://Service/", "verser");
    private final static QName _SetHistoriqueResponse_QNAME = new QName("http://Service/", "setHistoriqueResponse");
    private final static QName _Exist_QNAME = new QName("http://Service/", "exist");
    private final static QName _RetirerResponse_QNAME = new QName("http://Service/", "retirerResponse");
    private final static QName _GetActe_QNAME = new QName("http://Service/", "getActe");
    private final static QName _SetHistorique_QNAME = new QName("http://Service/", "setHistorique");
    private final static QName _Transfert_QNAME = new QName("http://Service/", "transfert");
